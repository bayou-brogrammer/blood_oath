...
// Map Panel
pub const MAP_PANEL_WIDTH: i32 = UI_DISPLAY_WIDTH - STATS_PANEL_WIDTH - 1;
pub const MAP_PANEL_HEIGHT: i32 = UI_DISPLAY_HEIGHT - 1;
...
pub const EQUIPMENT_PANEL_HEIGHT: i32 = UI_DISPLAY_HEIGHT - LOG_PANEL_HEIGHT - STATS_PANEL_HEIGHT;

lazy_static! {
    pub static ref MAP_PANEL: Rect = Rect::with_size(0, 0, MAP_PANEL_WIDTH, MAP_PANEL_HEIGHT);
    pub static ref LOG_PANEL: Rect =
        Rect::with_size(0, UI_DISPLAY_HEIGHT - LOG_PANEL_HEIGHT, LOG_PANEL_WIDTH, LOG_PANEL_HEIGHT);
    ...
    pub static ref OVERALL_PANEL: Rect = Rect::with_size(0, 0, UI_DISPLAY_WIDTH - 1, UI_DISPLAY_HEIGHT - 1);
}
...
pub fn box_framework(draw_batch: &mut DrawBatch) {
    ...
    draw_batch.set(
        Point::new(UI_DISPLAY_WIDTH - 1, MAP_PANEL_HEIGHT),
    ...
    draw_batch.set(
        Point::new(UI_DISPLAY_WIDTH - 1, STATS_PANEL_HEIGHT),
        ColorPair::new(BOX_GRAY, BLACK),
        to_cp437('┤'),
    );
}
