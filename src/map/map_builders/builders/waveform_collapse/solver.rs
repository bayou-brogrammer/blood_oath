...
impl Solver {
    ...
    pub fn iteration(&mut self, map: &mut Map) -> bool {
        ...
        let remaining_index = if !neighbors_exist {
            (bo_utils::rng::roll_dice(1, self.remaining.len() as i32) - 1) as usize
        } else {
            0usize
        };
        ...
        if neighbors == 0 {
            ...
            let new_chunk_idx = (bo_utils::rng::roll_dice(1, self.constraints.len() as i32) - 1) as usize;
            ...
            if possible_options.is_empty() {
                ...
                let new_chunk_idx = if possible_options.len() == 1 {
                    ...
                    bo_utils::rng::roll_dice(1, possible_options.len() as i32) - 1
                };
